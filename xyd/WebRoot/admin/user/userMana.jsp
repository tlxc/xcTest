...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
        ...
        <script language="javascript">
           ...
           {
				var strUrl = "<%=path %>/admin/user/chongzhi.jsp?userId="+userId;
	...
	<body leftmargin="2" topmargin="2" background='<%=path %>/img/allbg.gif'>
			<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
				<tr bgcolor="#E7E7E7">
					<td height="14" colspan="18" background="<%=path %>/img/tbg.gif">&nbsp;会员信息管理&nbsp;</td>
				</tr>
				...
				<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='red';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
					...
					<td bgcolor="#FFFFFF" align="center">
					    ...
					    &nbsp;&nbsp;&nbsp;
					    <a href="#" style="color: red" onclick="chongzhi(<s:property value="#user.userId"/>)" class="pn-loperator">充值</a>
					</td>
					<td bgcolor="#FFFFFF" align="center">
